<script lang="ts">
  import TutorsIcon from "../../components/navigators/support/TutorsIcon.svelte";
    ...
    <div class="flex flex-wrap justify-items-center shadow-md rounded-lg px-4 py-2 bg-base-200 text-base-content m-8">
      ...
      <div class="font-sm font-light text-l text-left p-2">
        <p class="p-2">
          ...
          information via the TutorsTime feature on the course Navigator.
        </p>
        ...
        <p class="p-2">
          TutorsLive also uses this data to display of panel of students currently online. You can opt out of this feature from
          the TutorsLive page.
        </p>
